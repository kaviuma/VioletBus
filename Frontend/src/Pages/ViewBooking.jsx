...
{showModal && selectedBooking && (
  <div className="modal-backdrop-custom" onClick={() => setShowModal(false)} >
    <div className="modal-dialog-custom" onClick={(e) => e.stopPropagation()} >
        <h4 className="text-danger text-center fw-bold mb-3">  Cancel Booking </h4>
      ...
      <p className="text-center"> Please provide a reason for cancellation: </p>
      ...
      <div className="d-flex justify-content-center gap-2 mt-3">
        <button className="btn btn-secondary px-4" onClick={() => setShowModal(false)} > Close </button>
        <button className="btn btn-danger px-4" onClick={handleCancel} > Confirm Cancel</button>
      </div>
    </div>
  </div>
)}
