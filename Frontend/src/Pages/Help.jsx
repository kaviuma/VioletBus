  ...
  return (
    <div className="container my-5">
      ...
      <div className=" border-0 p-10" >
        ...
        <p>
          We’re here to help you! If you face any issue while booking, cancelling,
          or viewing tickets, feel free to reach out.
        </p>
        ...
        <p>
          Violet Bus Pvt Ltd,Tenkasi - 627811.
        </p>

        <p className="text-center text-muted mt-4 mb-0">
          © 2025 Violet Bus | Safe • Fast • Reliable
        </p>
      </div>
    </div>
  );
